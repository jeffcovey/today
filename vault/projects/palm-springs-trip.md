# Palm Springs Trip
<!-- project-id: cf3f8e4a115038672753986e3c78ccfb -->
...
- [ ] Tell Lou about Don Schmoll

### Pre-Trip (1 week before)

- [x] Arrange house/room coverage (Vince Gartland confirmed) <!-- task-id: afb37379a647ac5faed1420d8ac9166c -->
...
- [x] Stop mail delivery <!-- task-id: 883a7cbf5821a7ee53a1fa62f5069914 -->
- [x] Prep guest rooms for any bookings <!-- task-id: 5f88eb30379990bccdf0aed0b036cd2f -->
...
- **Flights:** ✅ BOOKED with American Airlines ($300 solo travel)
...
- September is still hot (100°F+) - plan indoor activities for afternoons
- Book dinner reservations in advance for popular spots
- Consider travel insurance given hurricane season
- Pack sunscreen SPF 50+

## Related Files

- `notes/daily/2025-08-11-*.md` - Initial planning discussions
- `notes/tasks/tasks.md` - Related tasks
...
- **Virgin Red Points Issue (for reference):** Unable to access Virgin Atlantic account to use points for booking
