...
export default {
  ...
  transform: {},
  modulePathIgnorePatterns: [...localMounts.map(t => `<rootDir>/${t}/`), '<rootDir>/.worktrees/', '<rootDir>/.claude/', '<rootDir>/.data/'],
  testPathIgnorePatterns: ['/node_modules/', '/.worktrees/', '/.claude/', '/.data/'],
  moduleNameMapper: {
    '^(\\.{1,2}/.*)\\.js$': '$1'
  },
  testMatch: [
